USE codeup_test_db;
    ...
    VALUES ('Michael Jackson', 'Thriller', 1982, 50.2, 'Pop'),
           ...
           ('Eagles', 'The Greatest Hits', 1976, 41.2, 'Country Rock'),
           ...
           ('RCA Records', 'Dirty Dancing', 1987, 24.1, 'Pop'),
           ...
           ('Bob Marley & The Wailers', 'Legend: The Best of Bob Marley & The Wailers',1999, 22.9, 'Reggae'),
           ...
           ('Dire Straits', 'Brother''s in Arms', 1985, 21.1, 'Roots Rock'),
           ...
           ('The Beatles', 'Abbey Road', 1969, 16.1, 'Rock')